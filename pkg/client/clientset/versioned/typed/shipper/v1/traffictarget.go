...
type TrafficTargetInterface interface {
	Create(*v1.TrafficTarget) (*v1.TrafficTarget, error)
	Update(*v1.TrafficTarget) (*v1.TrafficTarget, error)
	UpdateStatus(*v1.TrafficTarget) (*v1.TrafficTarget, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.TrafficTarget, error)
	List(opts meta_v1.ListOptions) (*v1.TrafficTargetList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.TrafficTarget, err error)
...
func newTrafficTargets(c *ShipperV1Client, namespace string) *trafficTargets {
...
func (c *trafficTargets) Get(name string, options meta_v1.GetOptions) (result *v1.TrafficTarget, err error) {
...
func (c *trafficTargets) List(opts meta_v1.ListOptions) (result *v1.TrafficTargetList, err error) {
	result = &v1.TrafficTargetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Create(trafficTarget *v1.TrafficTarget) (result *v1.TrafficTarget, err error) {
	result = &v1.TrafficTarget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Update(trafficTarget *v1.TrafficTarget) (result *v1.TrafficTarget, err error) {
	result = &v1.TrafficTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) UpdateStatus(trafficTarget *v1.TrafficTarget) (result *v1.TrafficTarget, err error) {
	result = &v1.TrafficTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *trafficTargets) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.TrafficTarget, err error) {
	result = &v1.TrafficTarget{}
