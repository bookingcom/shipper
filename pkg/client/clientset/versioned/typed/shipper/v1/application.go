...
type ApplicationInterface interface {
	...
	UpdateStatus(*v1.Application) (*v1.Application, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.Application, error)
	List(opts meta_v1.ListOptions) (*v1.ApplicationList, error)
...
func newApplications(c *ShipperV1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *applications) Get(name string, options meta_v1.GetOptions) (result *v1.Application, err error) {
...
func (c *applications) List(opts meta_v1.ListOptions) (result *v1.ApplicationList, err error) {
...
func (c *applications) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("applications").
...
func (c *applications) UpdateStatus(application *v1.Application) (result *v1.Application, err error) {
	result = &v1.Application{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applications").
...
func (c *applications) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *applications) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("applications").
