...
type StrategyInterface interface {
	Create(*v1.Strategy) (*v1.Strategy, error)
	Update(*v1.Strategy) (*v1.Strategy, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.Strategy, error)
	List(opts meta_v1.ListOptions) (*v1.StrategyList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Strategy, err error)
	StrategyExpansion
}
...
func newStrategies(c *ShipperV1Client, namespace string) *strategies {
	return &strategies{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *strategies) Get(name string, options meta_v1.GetOptions) (result *v1.Strategy, err error) {
	result = &v1.Strategy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("strategies").
...
func (c *strategies) List(opts meta_v1.ListOptions) (result *v1.StrategyList, err error) {
	result = &v1.StrategyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("strategies").
...
func (c *strategies) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("strategies").
...
func (c *strategies) Create(strategy *v1.Strategy) (result *v1.Strategy, err error) {
	result = &v1.Strategy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("strategies").
...
func (c *strategies) Update(strategy *v1.Strategy) (result *v1.Strategy, err error) {
	result = &v1.Strategy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("strategies").
...
func (c *strategies) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *strategies) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("strategies").
...
func (c *strategies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Strategy, err error) {
	result = &v1.Strategy{}
