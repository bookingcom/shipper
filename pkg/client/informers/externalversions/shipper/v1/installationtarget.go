...
type InstallationTargetInformer interface {
	...
	Lister() v1.InstallationTargetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.ShipperV1().InstallationTargets(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ShipperV1().InstallationTargets(namespace).Watch(options)
			},
		},
		&shipper_v1.InstallationTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *installationTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&shipper_v1.InstallationTarget{}, f.defaultInformer)
}

func (f *installationTargetInformer) Lister() v1.InstallationTargetLister {
	return v1.NewInstallationTargetLister(f.Informer().GetIndexer())
}
