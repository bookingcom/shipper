...
import (
	...
	shipper "github.com/bookingcom/shipper/pkg/client/informers/externalversions/shipper"
...
func (f *sharedInformerFactory) Shipper() shipper.Interface {
	return shipper.New(f, f.namespace, f.tweakListOptions)
}
