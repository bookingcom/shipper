...
func GetTargetStep(rel, succ *shipper.Release, strategy *shipper.RolloutStrategy, stepsFromAchievedStep int, progressing, achievedTargetStep bool) (int32, error) {
	isHead := succ == nil
