...
// EventHandlerRegisterFunc is called after the caches for the
// clusters have been built, and provides a hook for a controller to
// register its event handlers. These will be event handlers for
// changes to the resources that the controller has subscribed to in
// the `SubscriptionRegisterFunc` callback.
