...
setup: $(SHIPPER_CLUSTERS_YAML) build/shipperctl.$(GOOS)-amd64
	./build/shipperctl.$(GOOS)-amd64 clusters setup management -n $(SHIPPER_NAMESPACE) $(SETUP_MGMT_FLAGS)
	./build/shipperctl.$(GOOS)-amd64 clusters join -f $(SHIPPER_CLUSTERS_YAML) -n $(SHIPPER_NAMESPACE) $(SETUP_JOIN_FLAGS)
	./build/shipperctl.$(GOOS)-amd64 clusters setup application -n $(SHIPPER_NAMESPACE) $(SETUP_APP_FLAGS)
